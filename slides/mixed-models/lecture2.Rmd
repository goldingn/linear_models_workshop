...
>        + can break indepedence assumptions
...
>- parameters differ among categories
>- some definitions:
...
>- my definition: random if categories are linked or if they break independence assumptions
...
>- independent observations (conditional on random effects)
...
> `VarCorr(mod)` is useful for this (but so is `)
